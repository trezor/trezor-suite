...
const groups = {
    api: {
        name: 'api',
        pattern:
            'authorizeCoinjoin cancelCoinjoinAuthorization passphrase unlockPath setBusy authenticateDevice keepSession cancel.test info.test discoverAccounts resetDevice',
        includeFilter: '',
    },
