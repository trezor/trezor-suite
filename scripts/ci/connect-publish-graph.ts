...
// `./read-workspace-deps`. Splitting them keeps this module purely
// in-memory so it can be unit-tested without filesystem fixtures.
//
...
// Future: pack-packages.ts and a custom eslint rule for missing-runtime-deps.
