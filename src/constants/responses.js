...
export const GET_BLOCK_HASH: 'r_get_block_hash' = 'r_get_block_hash';
export const GET_ACCOUNT_INFO: 'r_account_info' = 'r_account_info';
export const GET_ACCOUNT_UTXO: 'r_get_account_utxo' = 'r_get_account_utxo';
export const GET_TRANSACTION: 'r_get_transaction' = 'r_get_transaction';
