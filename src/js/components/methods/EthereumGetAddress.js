...
import * as EthereumGetAddressActions from '../../actions/methods/EthereumGetAddressActions';

import Response from './common/Response';

const EthereumGetAddress = (props): any => {
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.ethgetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(EthereumGetAddressActions, dispatch),
        };
    }
)(EthereumGetAddress);