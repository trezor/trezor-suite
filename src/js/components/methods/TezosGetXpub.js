...
import * as TezosGetXpubActions from '../../actions/methods/TezosGetXpubActions';

import Response from './common/Response';

const TezosGetXpub = (props): any => {
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.tezosgetxpub,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(TezosGetXpubActions, dispatch),
        };
    }
)(TezosGetXpub);