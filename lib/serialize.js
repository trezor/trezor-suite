...
function sTypedArray<V>(m: ImmutableMap<string, V>) { return { '#': 'Uint8Array', data: Array.from(m) }; }
...
function dTypedArray(a) { return a.data; }
