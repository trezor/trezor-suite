...
export class BitcoreBlockchain {
    ...
    constructor(endpoint: string, socketWorker: Worker) {
        this.addresses = new ImmutableSet();
        this.socket = new Socket(socketWorker, endpoint);
...
class SocketWorkerHandler {
    ...
    constructor(worker: Worker, endpoint: string) {
        this.worker = worker;
        this.counter = 0;
...
class Socket {
    ...
    constructor(worker: Worker, endpoint: string) {
        ...
        this.socket = new SocketWorkerHandler(worker, endpoint);
    }
