...
channel.startDiscoveryPromise.then(() => {
    ...
    loadBlockRange(initialState).then(range => {
        ...
        return discoverAccount(range, [lastUsedMain, lastUsedChange], unconfirmedTxids)
...
//    unconfirmedTxids: Array<string>
    ...
    return Promise.all([
        new GetChainTransactions(0, range, lastUsedAddresses[0], channel.chunkTransactions).discover(),
