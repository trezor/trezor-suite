...
export class WorkerChannel {
    ...
    handleStreamRequest(request: StreamRequestOutMessage) {
        ...
        const disposeHandler = (message, detach) => {
            if (message.type === 'streamRequestDispose') {
        ...
        stream.finish.attach(value => {
            ...
            this.messageEmitter.detach(disposeHandler);
        });

        this.messageEmitter.attach(disposeHandler);
    }
}
