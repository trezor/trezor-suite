...
/**
 * Reads the ledger head from Horizon, for when Stellar RPC is unreachable. It serves the same four
 * fields the RPC path decodes out of the ledger header, so a degraded read loses nothing here.
 */
