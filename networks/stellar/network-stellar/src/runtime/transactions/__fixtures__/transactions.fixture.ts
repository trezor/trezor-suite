...
export const buildSendTransaction = [
    {
        ...
        expectedOutput: new TransactionBuilder(
            new Account('GCNLIUDTVTL25HC64AH3MTTZ7RUGOOGB5H3A2P7BWRBW2SPAZ6F3LIM2', '123456789'),
            {
                fee: '1200',
...
export const buildAddTrustlineTransaction = [
    ...
    {
        description:
            'transaction contains a change trust operation, but destinationTag is undefined',
        input: {
            descriptor: TRUSTLINE_SOURCE,
            sequence: TRUSTLINE_SEQUENCE,
            fee: TRUSTLINE_FEE,
