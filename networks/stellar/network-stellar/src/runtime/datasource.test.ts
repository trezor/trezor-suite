...
import type { StellarConnection, StellarHorizonServer } from '../types';
...
const createApi = (
    rpc: Partial<StellarRpcServer>,
    horizon: StellarHorizonServer,
): StellarConnection => ({ rpc: rpc as StellarRpcServer, horizon }) as StellarConnection;

describe(createStellarDataSource.name, () => {
