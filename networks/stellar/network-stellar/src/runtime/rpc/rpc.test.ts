...
describe('rpc/decode', () => {
    describe(decodeAccountEntry.name, () => {
    ...
    describe(decodeTrustlineEntry.name, () => {
    ...
    describe(decodeLedgerHeader.name, () => {
...
describe('rpc/submit', () => {
    ...
    it('reports a send a congested node never queued, rather than the hash', async () => {
        ...
        // Advancing the timers inside the awaited expression keeps the rejection handled.
        await expect(
            Promise.all([
