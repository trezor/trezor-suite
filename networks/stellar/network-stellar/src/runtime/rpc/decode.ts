...
// Liabilities live in the v1 extension, sponsorship counters in the v2 extension nested in it.
...
// Asset codes are NUL-padded on the wire; a trailing-NUL regex would backtrack quadratically.
