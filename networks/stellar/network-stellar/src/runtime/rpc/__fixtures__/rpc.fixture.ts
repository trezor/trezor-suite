// Recorded `getLedgerEntries` / `getLatestLedger` payloads: base64 XDR exactly as a stellar-rpc
// node returns it. Regenerate by re-encoding the entries below with @stellar/stellar-sdk.
