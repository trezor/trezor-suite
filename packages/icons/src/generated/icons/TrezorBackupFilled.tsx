...
const SvgTrezorBackupFilled = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32" {...props}>
        <g fill="currentColor" clipPath="url(#trezorBackupFilled_svg__a)">
        ...
        <defs>
            <clipPath id="trezorBackupFilled_svg__a">
                <path fill="currentColor" d="M0 0h32v32H0z" />
            </clipPath>
        </defs>
    </svg>
);
export { SvgTrezorBackupFilled as ReactComponent };
