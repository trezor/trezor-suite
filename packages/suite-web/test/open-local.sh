...
yarn concurrently --success first --kill-others  "python3 ./test/plugins/python/main.py" "wait-on --timeout 10000 http://localhost:3000 && cypress open --config baseUrl=http://localhost:3000 --browser chrome"