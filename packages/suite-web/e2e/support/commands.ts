...
Cypress.Commands.add('interceptInvityApiSavingsBtcDirect', interceptInvityApiSavingsBtcDirect);
Cypress.Commands.add('interceptInvityApiSavingsSwan', interceptInvityApiSavingsSwan);
