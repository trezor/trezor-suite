...
const KNOWN_OVERSIZED_DECLARATIONS: string[] = [
    ...
    'packages/connect/libDev/src/impl/core-in-module.d.ts',
    'packages/connect/libDev/tests/typedCall.type-test.d.ts',
    'packages/suite/libDev/src/actions/wallet/__fixtures__/blockchainActions.d.ts',
    'packages/suite/libDev/src/actions/wallet/__fixtures__/coinjoinAccountActions.d.ts',
    'packages/suite/libDev/src/actions/wallet/__fixtures__/coinjoinClientActions.d.ts',
    'packages/suite/libDev/src/actions/wallet/__fixtures__/selectedAccountActions.d.ts',
    'packages/suite/libDev/src/middlewares/suite/sentryMiddleware.d.ts',
    'suite-common/earn-stablecoin-api/libDev/src/services/yieldxyz.d.ts',
    'suite-common/icons/libDev/src/icons.d.ts',
    'suite-common/wallet-utils/libDev/src/accountUtils.d.ts',
    'suite-native/app/libDev/src/navigation/routes.d.ts',
    'suite/coinjoin/libDev/src/__fixtures__/coinjoinAccountActions.d.ts',
    'suite/coinjoin/libDev/src/__fixtures__/coinjoinClientActions.d.ts',
];
