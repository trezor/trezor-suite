...
export const messages = defineMessages({
    ...
    TR_SETTINGS_COINS_BANNER_TITLE_REMEMBERED_DISCONNECTED: {
        defaultMessage: 'Remembered device is not connected',
        id: 'TR_SETTINGS_COINS_BANNER_TITLE_REMEMBERED_DISCONNECTED',
    },
