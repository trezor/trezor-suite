...
import { IconButton, IconButtonProps, Row, Spinner, Tooltip } from '@trezor/components';
...
const Container = styled.div<{
    ...
    background: ${({ theme }) => theme.baseFillSurfaceModal};
    border-radius: 8px;
    display: flex;
    align-items: center;
...
export const ActionsContainer = ({
    ...
    return (
        <Container
            ...
            inert={!isActive}
        >
            <Row gap={4} alignItems="center" minHeight={28}>
                {getContent()}
            </Row>
        </Container>
    );
