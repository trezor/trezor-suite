...
import { SESSION_NOT_FOUND, UNEXPECTED_ERROR } from '@trezor/transport-abstract/src/errors';
import { validateProtocolMessage } from '@trezor/transport-abstract/src/utils/bridgeProtocolMessage';
