...
import { readWithExpectedState, receiveThpMessage, sendThpMessage } from '../src/thp';
...
describe('thp', () => {
    ...
    describe('readWithExpectedState', () => {
        it('aborted', async () => {
            ...
            const resultPromise = readWithExpectedState(apiRead, thpState, abortController.signal);
    ...
    describe('receiveThpMessage', () => {
        ...
        it('success. ThpAck not required', async () => {
            ...
            thpState.setChannel(readResult.subarray(1, 3));
            thpState.setExpectedResponse([0x41]); // ThpCreateChannelResponse
