...
- npm-prerelease: @trezor/transport 10.0.0-beta.3 (f753ec4191)
- npm-prerelease(connect): bump remaining 10.0.0-beta.2 references (f19f708c59)
- npm-prerelease: @trezor/transport 10.0.0-beta.2 (3025d20738)
...
- test(transport): co-locate UDP API test (66eb108bf6)
...
- fix(connect): remove stale react-native ping target and sort transport import (f793c7aaec)
...
- refactor(transport): drop legacy hex-without-envelope bridge format (7e2ddc5b85)
- chore(scripts): rename libESM to lib (f046a3fd2b)
- chore(scripts): remove cjs support in replace-imports.sh (a1059cd8a3)
- chore(transport): drop stale trezord-go URL comments (5a4214f865)
...
- feat: add optional env var to disable transport browser ping (7e42e55c57)
- chore(transport): drop unused configured field from bridge info response (0376fb4d7b)
- chore(transport): switch usb test mock to ESM (274ca5f84c)
- chore(transport): drop unused createBridgeTransports helper (1a39621522)
- refactor(transport): split into transport-common / transport / transport-web (f498dcebb7)
- chore(transport): tighten Logger interface rest-args to unknown[] (435e73f4b5)
...
- fix(transport): handle packet loss (ca2daac809)
- refactor: adopt isArrayMember from @trezor/utils (019211dd10)
- fix(transport): fix webusb transport on browsers without native SharedWorker support (82c1573de2)
- feat(connect): drop CommonJS output across connect ecosystem (b99609bfb8)
- chore(transport): remove unused version() bridge API response parser (3b4e6ecf64)
- chore: use type imports (b4caf7f0ac)
- build(suite-web): remove deprecated worker-loader (eba6ed2b8a)
- build(suite): change desktop publicPath and remove evolu hack (9019d941b7)
- fix(connect): don't import from browser file (1a01676377)
...
- chore(deps): bump usb to 2.17.0 (25c7fc1020)
- fix: broaden Buffer types (fcf8d95b9b)
- chore(tests): migrate web packages to @swc/jest (15192f30ee)
- fix(transport): widen DescriptorApiLevel.id to string | null (bf0a489396)
- fix(transport): adapt to @types/w3c-web-usb v1.0.14 USBDevice.serialNumber type (289a64b893)
...
- chore(transport): remove unused export (49295703ea)
- chore(transport): use code instead of error naming convention (c88b9933be)
- chore(transport): remove passthrough success and error class members (c032108657)
- chore: in transport, use result type from type-utils (69b797f60c)
- feat(protocol): add `piggybackAck` support (ed82a11ea4)
- fix(transport): usb disconnection without serialNumber (940a86fdf4)
...
- test: add global mock for `usb` dependency (1cf032552e)
- chore: Bump babel (8392255f95)
- refactor(transport): resolve circular imports (8aaa453fc8)
- chore: remove unused `prepublishOnly` script (0056cb62fa)
- feat(transport): use bridge `/abort` endpoint (a328218e82)
- chore: Bump babel (dddbb03058)
- fix(connect): THP loop ackBit check (0ce577530a)
- feat: improve USB write performance in mobile app (5ccfee82eb)
- chore(transport): remove obsolete THP code (3dd5d01ce5)
- refactor(transport): THP call/send/receive flow (729f7ae250)
- docs(transport): fix github links (7e4366aa8a)
- chore: bump tsx version (98321960e2)
- chore(transport): add `model` to `DescriptorApiLevel` (45529fd576)
- npm-prerelease: set all @trezor/connect dependencies to 10.0.0-alpha.1 (ab01b2d889)
- refactor(transport): rename ThpStateMissing > ThpStateError (4c22b0034e)
- chore(npm): remove prepublish.js (7559f035c3)
- build(repository): Connect publishing ESM (a9e189b9a3)
- chore(transport): Protocol decode failed log error (06c16e446a)
