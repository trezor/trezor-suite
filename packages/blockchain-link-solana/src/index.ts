...
import type { ParsedTransactionWithMeta, SolanaValidParsedTxWithMeta } from './solana-types';
import { type TokenProgramName, tokenProgramsInfo, transformTokenInfo } from './solanaUtils';
import * as solanaUtils from './solanaUtils';
import type {
    SolanaAccountInfo,
    SolanaMisc,
...
const getAccountInfo = async (request: Request<MessageTypes.GetAccountInfo>) => {
    ...
    if (details === 'txids') {
        ...
        const account: SolanaAccountInfo = {
