...
export type TODOReq = {
    ...
    (method: 'connect_device', uuid: string): Promise<boolean>;
    (method: 'disconnect_device', uuid: string): Promise<boolean>;
    (method: 'forget_device', uuid: string): Promise<boolean>;
    (method: 'open_device', uuid: string): Promise<boolean>;
    (method: 'close_device', uuid: string): Promise<boolean>;
    (method: 'read', uuid: string): Promise<boolean>;
