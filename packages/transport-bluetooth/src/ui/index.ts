import { TrezorBleApi } from '../client/trezor-ble-api';
...
const updateDeviceList = (api: TrezorBleApi, devices: BluetoothDevice[]) => {
...
async function init() {
    ...
    api.on('AdapterStateChanged', powered => {
        ...
        writeOutput(`AdapterStateChanged connected: ${powered}`);
    });
