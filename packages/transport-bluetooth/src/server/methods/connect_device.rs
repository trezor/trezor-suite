...
use crate::server::types::{
    ChannelMessage, MethodError, MethodResult, NotificationEvent, WsResponsePayload,
};
...
pub async fn connect_device(
    ...
    connect_device_target(manager.clone(), broadcast.clone(), device.clone(), timeout).await?;
