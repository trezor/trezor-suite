...
import * as AEValidator from './ae_validator';
import * as ARDRValidator from './ardr_validator';
...
import * as ICXValidator from './icx_validator';
import * as IOSTValidator from './iost_validator';
import * as LSKValidator from './lisk_validator';
import * as LokiValidator from './loki_validator';
...
import * as NXTValidator from './nxt_validator';
...
import * as STEEMValidator from './steem_validator';
import * as XLMValidator from './stellar_validator';
import * as SYSValidator from './sys_validator';
