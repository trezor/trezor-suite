...
const { versionUtils } = require('@trezor/utils');
const releases2 = require('@trezor/connect-common/files/firmware/2/releases.json');
const releases1 = require('@trezor/connect-common/files/firmware/1/releases.json');
