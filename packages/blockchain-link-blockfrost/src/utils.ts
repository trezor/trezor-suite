...
export const transformUtxos = (utxos: BlockfrostUtxos[]): CardanoUtxo[] => {
    const result: CardanoUtxo[] = [];
    utxos.forEach(utxo =>
...
export const transformAccountInfo = (info: BlockfrostAccountInfo): CardanoAccountInfo => {
