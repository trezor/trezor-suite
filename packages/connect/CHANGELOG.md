...
The [migration guide](https://connect.trezor.io/10/guides/migrating-to-connect-10) turns the changes below into a step-by-step checklist with before/after code.
