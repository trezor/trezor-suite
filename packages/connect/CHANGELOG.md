...
| :------------------------------: | :----: | :----------: |
|       npm @trezor/connect        | 9.6.1  | 9.6.2-beta.1 |
|     npm @trezor/connect-web      | 9.6.1  | 9.6.2-beta.1 |
| npm @trezor/connect-webextension | 9.6.1  | 9.6.2-beta.1 |
|    npm @trezor/connect-mobile    | 9.6.1  | 9.6.2-beta.1 |

|     Deployment     | Stable |    Canary    |
| :----------------: | :----: | :----------: |
| connect.trezor.io/ | 9.6.1  | 9.6.2-beta.1 |
