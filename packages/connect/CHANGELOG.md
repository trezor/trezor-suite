...
| :------------------------------: | :----: | :----------: |
|       npm @trezor/connect        | 9.4.3  | 9.4.4-beta.1 |
|     npm @trezor/connect-web      | 9.4.3  | 9.4.4-beta.1 |
| npm @trezor/connect-webextension | 9.4.3  | 9.4.4-beta.1 |

|     Deployment     | Stable |    Canary    |
| :----------------: | :----: | :----------: |
| connect.trezor.io/ | 9.4.3  | 9.4.4-beta.1 |
