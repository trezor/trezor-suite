...
import { FirmwareReleaseConfigInfo } from '@trezor/connect-common/src/types/firmware';
import type { CurrentVersion } from '@trezor/connect-common/src/types/firmware';
import {
    ConditionalRelease,
    DeviceModelInternal,
    FirmwareRelease,
