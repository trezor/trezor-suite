...
describe('firmware/calculateFirmwareHash', () => {
    ...
    // TT results from https://github.com/trezor/trezor-firmware/blob/master/core/tests/test_trezor.utils.py
    it('TT with challenge', () => {
