...
export class TransactionComposer {
    ...
    composed: { [key: string]: PrecomposeResult } = {};
    ...
    constructor(options: Options) {
        ...
        this.utxos = options.utxos.flatMap(u => {
            ...
            return {
                ...
                own: typeof u.own === 'boolean' ? u.own : allAddresses.indexOf(u.address) >= 0, // decide if it can be spent immediately (own) or after 6 conf (not own)
            };
        });
    }
    ...
    compose(feeRate: string): PrecomposeResult {
