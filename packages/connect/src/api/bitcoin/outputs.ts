...
import type { ComposeOutputParam, PrecomposeResultFinal } from '../../types/api/composeTransaction';
...
export const outputToTrezor = (
    output: PrecomposeResultFinal['transaction']['outputs']['sorted'][0],
): PROTO.TxOutputType => {
    if (output.type === 'opreturn') {
        return {
            amount: '0',
            op_return_data: output.dataHex, // TODO: verify prefixing
