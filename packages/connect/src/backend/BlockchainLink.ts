...
import BlockchainLink, { SubscriptionAccountInfo } from '@trezor/blockchain-link';

import type {
    AccountInfoParams,
    AccountBalanceHistoryParams,
} from '@trezor/blockchain-link/lib/types/params'; // REF-TODO: export from B-L
...
export default class Blockchain {
    ...
    getAccountBalanceHistory(params: AccountBalanceHistoryParams) {
    ...
    getAccountInfo(request: AccountInfoParams) {
