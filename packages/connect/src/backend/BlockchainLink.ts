...
export class Blockchain {
    ...
    onError(error: ERRORS.TrezorError) {
        ...
        removeBackend(this); // eslint-disable-line @typescript-eslint/no-use-before-define
    }
    ...
    async init() {
        this.link.on('connected', async () => {
            ...
            setPreferredBacked(this.coinInfo, cleanUrl || info.url); // eslint-disable-line @typescript-eslint/no-use-before-define
