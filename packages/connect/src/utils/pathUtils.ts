...
export const isMultisigPath = (path: Array<number> | undefined) =>
    Array.isArray(path) && path[0] === toHardened(48);

export const isSegwitPath = (path: Array<number> | undefined) =>
    Array.isArray(path) && path[0] === toHardened(49);

export const isBech32Path = (path: Array<number> | undefined) =>
    Array.isArray(path) && path[0] === toHardened(84);

export const isTaprootPath = (path: Array<number> | undefined) =>
    Array.isArray(path) && path[0] === toHardened(86);

export const getAccountType = (path: Array<number> | undefined) => {
...
export const getScriptType = (path: Array<number> | undefined): InternalInputScriptType => {
