    ...
    return (
        <div className={`method-result ${props.tab}`}>
            <div className="method-result-menu">
                <div data-tab="response" onClick={event => props.onTabChange('response')}>
                    Response
                </div>
                <div data-tab="code" onClick={event => props.onTabChange('code')}>
                    Javascript code
                </div>
                {/* <div data-tab="tests" onClick={ event => props.onTabChange('tests') }>Tests</div> */}
                {props.hasDocumentation && (
                    <div data-tab="docs" onClick={event => props.onTabChange('docs')}>
                        Documentation
                    </div>
                )}
            </div>
