...
import * as CardanoGetXpubActions from '../../actions/methods/CardanoGetXpubActions';
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.cardanogetxpub,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(CardanoGetXpubActions, dispatch),
        };
    }
)(CardanoGetAddress);