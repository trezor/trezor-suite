...
import * as TezosGetAddressActions from '../../actions/methods/TezosGetAddressActions';

import Response from './common/Response';

const TezosGetAddress = (props): any => {
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.tezosgetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(TezosGetAddressActions, dispatch),
        };
    }
)(TezosGetAddress);