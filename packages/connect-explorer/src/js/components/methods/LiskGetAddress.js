...
import * as LiskGetAddressActions from '../../actions/methods/LiskGetAddressActions';
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.liskgetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(LiskGetAddressActions, dispatch),
        };
    }
)(LiskGetAddress);