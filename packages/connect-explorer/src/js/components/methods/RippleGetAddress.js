...
import * as RippleGetAddressActions from '../../actions/methods/RippleGetAddressActions';

import Response from './common/Response';

const RippleGetAddress = (props): any => {
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.ripplegetaddress,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(RippleGetAddressActions, dispatch),
        };
    }
)(RippleGetAddress);