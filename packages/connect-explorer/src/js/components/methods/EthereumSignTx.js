...
import * as EthereumSignTxActions from '../../actions/methods/EthereumSignTxActions';

import Response from './common/Response';

const EthereumSignTx = (props): any => {
    ...
    return (
        <section className="method-content">
            ...
            <div className="method-params">
                ...
                <div className="row">
                    <label></label>
                    <button onClick={ event => onSignTx() }>Sign Ethereum transaction</button>
                </div>
            </div>
...
export default connect( 
    (state: State) => {
        return {
            common: state.common,
            state: state.ethsigntx,
        };
    },
    (dispatch: Dispatch) => {
        return {
            commonActions: bindActionCreators(CommonActions, dispatch),
            methodActions: bindActionCreators(EthereumSignTxActions, dispatch),
        };
    }
)(EthereumSignTx);