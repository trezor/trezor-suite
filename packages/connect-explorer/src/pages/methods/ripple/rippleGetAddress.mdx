...
import { GetAddress } from '@trezor/connect-common/src/types/params';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { Param } from '../../../components/Param';
import { ParamsTable } from '../../../components/ParamsTable';
import getAddress from '../../../data/methods/ripple/getAddress.ts';

<ApiPlayground
    options={[
        { title: 'Export address', legacyConfig: getAddress[0] },
        { title: 'Export multiple addresses', legacyConfig: getAddress[1] },
        { title: 'Advanced schema', method: 'rippleGetAddress', schema: GetAddress },
        { title: 'Advanced bundle', method: 'rippleGetAddress', schema: Bundle(GetAddress) },
    ]}
/>
