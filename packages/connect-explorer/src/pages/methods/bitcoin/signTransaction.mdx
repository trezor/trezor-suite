...
export const paramDescriptions = {
    coin:
        '> Determines the network definition. Coin `shortcut` (a `CoinSymbol`, e.g. `btc`) is used.\n' +
        '> See [supported coins](/details/coins) for every accepted value.\n',
    ...
    refTxs:
        'of [RefTransaction](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/bitcoin/common.ts).\n' +
...
[SignTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/bitcoin/common.ts)
