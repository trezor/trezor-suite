...
import { GetPublicKey } from '@trezor/connect-common/src/types/api/getPublicKey';
...
[HDNodeResponse type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/getPublicKey.ts)
