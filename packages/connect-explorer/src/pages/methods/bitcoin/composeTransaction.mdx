...
Prepare transaction to be signed by Trezor by providing account data (`path`, `utxo`, `changeAddress`) and `feeLevels` params and perform **only** transaction calculation. [[1]](#additional-notes)
