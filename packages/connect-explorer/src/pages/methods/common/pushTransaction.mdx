import { PushTransaction } from '@trezor/connect-common/src/types/api/blockchain/pushTransaction';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { ParamsTable } from '../../../components/ParamsTable';
import pushTransaction from '../../../data/methods/common/pushTransaction.ts';
...
[PushedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/blockchain/pushTransaction.ts)
