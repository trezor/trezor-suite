import { TezosSignTransaction } from '@trezor/connect-common/src/types/api/tezos';
...
export const paramDescriptions = {
    ...
    branch: '',
    operation:
        'type of [TezosOperation](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/tezos/index.ts)',
    chunkify:
