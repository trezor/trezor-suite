import { TezosSignTransaction } from '@trezor/connect-common/src/types/api/tezos/common';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { ParamsTable } from '../../../components/ParamsTable';
import signTransaction from '../../../data/methods/tezos/signTransaction.ts';
...
export const paramDescriptions = {
    ...
    branch: '',
    operation:
        'type of [TezosOperation](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/tezos/common.ts)',
    chunkify:
...
[TezosSignedTx type](https://github.com/trezor/trezor-suite/blob/develop/packages/protobuf/src/definitions/messages-tezos.ts)
