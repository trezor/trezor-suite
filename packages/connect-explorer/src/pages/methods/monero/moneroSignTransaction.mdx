...
import { MoneroSignTransaction } from '@trezor/connect-common/src/types/api/monero/common';
...
[MoneroSignedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/monero/common.ts)
