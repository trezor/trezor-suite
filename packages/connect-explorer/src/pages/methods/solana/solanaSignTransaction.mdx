import { SolanaSignTransaction } from '@trezor/connect-common/src/types/api/solana';
...
[SolanaSignedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/solana/index.ts)
