import { SolanaSignTransaction } from '@trezor/connect-common/src/types/api/solana/common';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { ParamsTable } from '../../../components/ParamsTable';
import signTransaction from '../../../data/methods/solana/signTransaction.ts';
...
[SolanaSignedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/solana/common.ts)
