import { SolanaComposeTransaction } from '@trezor/connect-common/src/types/api/solana/common';
...
[SolanaComposedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/solana/common.ts)
