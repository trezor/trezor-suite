import { SolanaComposeTransaction } from '@trezor/connect-common/src/types/api/solana';
...
[SolanaComposedTransaction type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/solana/index.ts)
