...
import { EthereumSignTransaction } from '@trezor/connect-common/src/types/api/ethereum';
...
export const paramDescriptions = {
    ...
    transaction:
        'type of [`EthereumTransactionEIP1559`](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/ethereum/index.ts)`|`[`EthereumSignTransaction`](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/ethereum/index.ts) "0x" prefix for each field is optional',
    chunkify:
...
[EthereumSignedTx type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/ethereum/index.ts)
