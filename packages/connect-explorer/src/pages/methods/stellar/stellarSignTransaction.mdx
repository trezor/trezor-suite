import { StellarSignTransaction } from '@trezor/connect-common/src/types/api/stellar/common';
...
export const paramDescriptions = {
    ...
    transaction:
        'type of [StellarTransaction](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/stellar/common.ts)',
};
...
[StellarSignedTx type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/stellar/common.ts)
