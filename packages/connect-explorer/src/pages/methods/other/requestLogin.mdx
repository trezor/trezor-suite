import { RequestLoginSchema } from '@trezor/connect-common/src/types/api/requestLogin';
...
[Login type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/requestLogin.ts)
