...
import { GetOwnershipProof } from '@trezor/connect-common/src/types/api/getOwnershipProof';
...
[OwnershipProof type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/getOwnershipProof.ts)
