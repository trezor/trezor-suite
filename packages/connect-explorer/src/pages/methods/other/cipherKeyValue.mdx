...
import { CipherKeyValue } from '@trezor/connect-common/src/types/api/cipherKeyValue';
...
[CipheredValue type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/cipherKeyValue.ts)
