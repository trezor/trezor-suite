...
import { CipherKeyValue } from '@trezor/connect-common/src/types/api/device/cipherKeyValue';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { Param } from '../../../components/Param';
import { ParamsTable } from '../../../components/ParamsTable';
import cipherkey from '../../../data/methods/other/cipherkey.ts';

<ApiPlayground
    options={[
        { title: 'Symmetrically encrypt / decrypt value', legacyConfig: cipherkey[0] },
        { title: 'Advanced schema', method: 'cipherKeyValue', schema: CipherKeyValue },
        {
...
[CipheredValue type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/device/cipherKeyValue.ts)
