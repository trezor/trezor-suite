...
import { GetAccountDescriptorParams } from '@trezor/connect-common/src/types/api/getAccountDescriptor';
...
[AccountInfo type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/account.ts)
