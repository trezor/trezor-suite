...
import { GetOwnershipId } from '@trezor/connect-common/src/types/api/device/getOwnershipId';
...
[OwnershipId type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/device/getOwnershipId.ts)
