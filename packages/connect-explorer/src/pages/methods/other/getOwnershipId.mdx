...
import { GetOwnershipId } from '@trezor/connect-common/src/types/api/getOwnershipId';
...
[OwnershipId type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/getOwnershipId.ts)
