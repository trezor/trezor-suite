...
import { CardanoGetAddress } from '@trezor/connect-common/src/types/api/cardano';

import { ApiPlayground } from '../../../components/ApiPlayground';
import { CommonParamsLink } from '../../../components/CommonParamsLink';
import { Param } from '../../../components/Param';
import { ParamsTable } from '../../../components/ParamsTable';
import getAddress from '../../../data/methods/cardano/getAddress.ts';

<ApiPlayground
    options={[
        { title: 'Export address', legacyConfig: getAddress[0] },
        { title: 'Advanced schema', method: 'cardanoGetAddress', schema: CardanoGetAddress },
        {
...
[CardanoAddress type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/cardano/index.ts)
