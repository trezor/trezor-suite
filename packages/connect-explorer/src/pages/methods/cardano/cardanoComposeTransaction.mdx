import { CardanoComposeTransactionParamsSchema } from '@trezor/connect-common/src/types/api/cardanoComposeTransaction';
...
[PrecomposedTransactionCardano[] type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/cardanoComposeTransaction.ts#L41)
