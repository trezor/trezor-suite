import { CardanoSignMessage } from '@trezor/connect-common/src/types/api/cardano/common';
...
[CardanoSignedMessage type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/cardano/common.ts)
