import { CardanoSignMessage } from '@trezor/connect/src/types/api/cardano';
...
export const paramDescriptions = {
    ...
    hashPayload:
        'if true, device will hash the payload before signing. Must be enabled if payload exceeds 1024 bytes',
