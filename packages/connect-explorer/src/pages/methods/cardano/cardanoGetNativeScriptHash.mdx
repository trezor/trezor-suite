import { CardanoGetNativeScriptHash } from '@trezor/connect-common/src/types/api/cardano';
...
[CardanoNativeScriptHash type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/cardano/index.ts)
