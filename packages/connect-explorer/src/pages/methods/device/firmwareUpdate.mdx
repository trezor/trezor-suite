...
import { FirmwareUpdate } from '@trezor/connect-common/src/types/api/firmwareUpdate';
...
[FirmwareUpdateResponse type](https://github.com/trezor/trezor-suite/blob/develop/packages/connect-common/src/types/api/firmwareUpdate.ts)
