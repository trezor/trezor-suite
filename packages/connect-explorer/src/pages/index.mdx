...
<SectionCard>
    ...
    <Cards num={2}>
        <Cards.Card icon={<IconNode />} title="Node.js" href="#nodejs" />
        <Cards.Card icon={<IconWeb />} title="Web" href="#web" />
        <Cards.Card icon={<IconExtension />} title="Web extension" href="#web-extension" />
        <BetaOnly>
            <Cards.Card icon={<IconMobile />} title="Mobile" href="#mobile" />
        </BetaOnly>
    </Cards>
...
<SectionCard>
    <SdkHeading className='_text-slate-900 dark:_text-slate-100'>
        <IconNode />
