...
<SectionCard>
    ...
    <SdkContainer>
        ...
        <div>
            ...
            To ensure your extension is displayed with its name rather than its ID, you need to open a Pull Request to include it in the knownHosts section of the file located at <a href="https://github.com/trezor/trezor-suite/blob/develop/packages/connect/src/data/config.ts#L17" target="_blank">this link</a>.
        </div>
