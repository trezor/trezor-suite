/* eslint-disable import/no-extraneous-dependencies -- react-native related dependencies have been excluded from the package.json file as a workaround, ensuring that they are not bundled with the suite-desktop app */
