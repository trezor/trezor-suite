...
import { ExchangeTradeStatus, SellTradeStatus, SavingsTradeItemStatus } from 'invity-api';
...
import type { TradeExchange, TradeSavings } from 'src/types/wallet/coinmarketCommonTypes';
