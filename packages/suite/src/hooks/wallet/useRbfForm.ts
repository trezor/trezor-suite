...
const useRbfState = ({ selectedAccount, rbfParams, chainedTxs }: UseRbfProps) => {
    ...
    const symbolFees = useSelector(state => selectNetworkFeeInfo(state, account.symbol));
    ...
    return useMemo(() => {
        const rbfFeeInfo = symbolFees ? getRbfFeeInfo(symbolFees, rbfParams) : DEFAULT_FEE_INFO;
        ...
        return {
            ...
            formValues: {
                ...
                ethereumDataHex: rbfParams.type === 'ethereum' ? rbfParams.ethereumData : undefined,
                rbfParams,
                baseFee,
            },
        };
