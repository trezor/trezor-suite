...
const routes = [
    ...
    {
        name: 'trade-buy-detail',
        pattern: 'accounts/trade/buy/detail',
        app: 'walletParams',
        params: walletParams,
    },
    {
    ...
    {
        name: 'wallet-trade-buy',
        pattern: '/accounts/trade/buy',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-exchange',
        pattern: '/accounts/trade/exchange',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-spend',
        pattern: '/accounts/trade/spend',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-buy-offers',
        pattern: '/accounts/trade/buy/offers',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-exchange-offers',
        pattern: '/accounts/trade/exchange/offers',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-buy-detail',
        pattern: '/accounts/trade/buy/detail',
        app: 'wallet',
        params: walletParams,
    },
    {
        name: 'wallet-trade-exchange-detail',
        pattern: '/accounts/trade/exchange/detail',
        app: 'wallet',
        params: walletParams,
    },
    {
