...
import TrezorConnect, { PROTO, RecoveryDevice, UI, UiResponseDevice } from '@trezor/connect';
...
const submit = (word: string, device: UiResponseDevice) => () => {
    TrezorConnect.uiResponse({ type: UI.RECEIVE_WORD, payload: word, device });
};
