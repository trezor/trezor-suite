export const SAVE_SELL_INFO = '@trading-sell/save_sell_info';
export const SAVE_QUOTE_REQUEST = '@trading-sell/save_quote_request';
export const SAVE_QUOTES = '@trading-sell/save_quotes';
export const SAVE_QUOTE = '@trading-sell/save_quote';
