 ...
 */
export const updateCurrentRates =
    (ticker: TickerId, maxAge = MAX_AGE) =>
 ...
 */
export const updateTxsRates =
    (account: Account, txs: AccountTransaction[]) => async (dispatch: Dispatch) => {
...
const updateMissingTxRates =
    (symbol?: Network['symbol']) => (dispatch: Dispatch, getState: GetState) => {
