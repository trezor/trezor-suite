...
const pushTransaction =
    (pendingTransaction: SignedTransaction['pendingTransaction']) =>
    async (dispatch: Dispatch, getState: GetState) => {
        ...
        if (sentTx.success) {
            ...
            if (
                ...
                pendingTransaction // bitcoin should have blockbookTx always defined
            ) {
                dispatch(
                    addFakePendingTxThunk({
                        transaction: { ...pendingTransaction, txid },
                        precomposedTx,
                        account,
                    }),
                );
...
export const signTransaction =
    ...
    async (dispatch: Dispatch, getState: GetState) => {
        ...
        let pendingTransaction: SignedTransaction['pendingTransaction'];
        ...
        if (decision) {
            ...
            return dispatch(pushTransaction(pendingTransaction));
        }
    };
