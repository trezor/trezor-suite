...
import type { ModalBackdropProps } from '@trezor/components/src/components/Modal/ModalBackdrop';
import { ModalBackdrop } from '@trezor/components/src/components/Modal/ModalBackdrop';
