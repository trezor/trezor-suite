...
import { variables, Button, Input, Icon, IconButton, colors, Paragraph } from '@trezor/components';
import TrezorConnect from '@trezor/connect';
import { isAndroid } from '@trezor/env-utils';

// import { DeviceConfirmImage } from 'src/components/suite/DeviceConfirmImage';
import { Translation, BundleLoader } from 'src/components/suite';
...
export const ThpPairingModal = (_: ThpPairingModalModalProps) => {
    ...
    return (
        <StyledDevicePromptModal pillTitle="Pairing with Trezor" data-test="@modal/thp-paring">
