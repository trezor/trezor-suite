...
import { MultiShareBackupCompleteModal } from './MultiShareBackupModal/MultiShareBackupCompleteModal';
...
export const UserContextModal = ({
    ...
    switch (payload.type) {
        ...
        case 'multi-share-backup-complete':
            return <MultiShareBackupCompleteModal />;
        default:
            return null;
    }
};
