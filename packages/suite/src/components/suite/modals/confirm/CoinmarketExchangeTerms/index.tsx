...
export const CoinmarketExchangeTerms = ({ decision, onCancel, provider }: Props) => {
            ...
            <Footer>
                <FooterContent>
                    <Checkbox
                        ...
                        data-test="@coinmarket/exchange/offers/buy-terms-agree-checkbox"
                    >
                        <CheckText>
                    ...
                    <Button
                        data-test="@coinmarket/exchange/offers/buy-terms-confirm-button"
