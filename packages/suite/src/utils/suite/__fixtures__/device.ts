...
const parseFirmwareChangelog = [
        ...
        device: {
            ...
            firmwareRelease: {
                ...
                latest: {
                    ...
                    min_firmware_version: [1, 6, 2],
                    min_bootloader_version: [1, 5, 0],
                    url: 'firmware/1/trezor-1.10.2.bin',
                    url_bitcoinonly: 'firmware/1/trezor-1.10.2-bitcoinonly.bin',
                    fingerprint: '99707b90a504f7e402f26c3d59cbbdacbc52754cebcce79cc47be528fc889338',
                    fingerprint_bitcoinonly:
                        'e597b6aef5a2e817f532d27b8501f99f189e432a887877bdd3498cd3a0afc431',
                ...
                changelog: [
                    {
                        ...
                        url_bitcoinonly: 'firmware/1/trezor-1.9.4-bitcoinonly.bin',
                        fingerprint:
                            '867017bd784cc4e9ce6f0875c61ea86f89b19380d54045c34608b85472998000',
                        fingerprint_bitcoinonly:
                            '3f73dfbcfc48f66c8814f6562524d81888230e0acd1c19b52b6e8772c6c67e7f',
                        notes: 'https://blog.trezor.io/trezor-suite-and-firmware-updates-rbf-and-spending-now-live-c2f69c42d7f7',
                        changelog:
                    ...
                    },
                    {
                        ...
                        fingerprint:
                            '2589f456559f813d1149be1022e62f2d48fbe28f4d02de933bd888d91035cace',
                        fingerprint_bitcoinonly:
                    ...
                    },
                    {
                        ...
                        fingerprint:
                            '45b83acd1330ddfd5567edbae5ff8028df1c48a493f01d47cc5499ee0be9b991',
                        fingerprint_bitcoinonly:
                    ...
                    },
                    {
                        ...
                        fingerprint:
                            '30cde253c46d4fc705f98634a35d06a494cf2a36824622a9c6a573e07f14292d',
                        fingerprint_bitcoinonly:
    ...
    {
        description: 'Parse latest changelog (intermediary)',
        device: {
            ...SUITE_DEVICE,
            features: {
                ...
                label: null,
                initialized: false,
                revision: 'e4cc08775fc9c204f295442f930326eb7877f2d4',
                bootloader_hash: '6330fcec1672fad30b421b60f74f839a3939334565cb703b2bd7182ea2dda019',
                imported: false,
                unlocked: true,
                firmware_present: null,
                needs_backup: false,
