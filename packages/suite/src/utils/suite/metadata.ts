...
import type { DataType, MetadataProvider } from '@suite-common/metadata-types';
import type { StaticSessionId } from '@trezor/connect';

import type { FetchIntervalTrackingId } from 'src/actions/suite/metadataProviderActions';
