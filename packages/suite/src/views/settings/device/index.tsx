                        ...
                        description={
                            <Version>
                                <Translation
                                    ...
                                    values={{
                                        version: (
                                            <VersionTooltip content={getFwRevision(device)|| ''}>
                                                <VersionLink
                                                    target="_blank"
                                                    href={`https://github.com/trezor/trezor-firmware/commit/${getFwRevision(device)}`}
                                                >
                                                    <VersionButton
                                                        variant="tertiary"
                                                        icon="EXTERNAL_LINK"
                                                        alignIcon="right"
                                                    >
                                                        {getFwVersion(device)}{isBitcoinOnly(device) && ' (bitcoin-only)'}
                                                    </VersionButton>
                                                </VersionLink>
                                            </VersionTooltip>
                                        ),
