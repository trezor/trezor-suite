...
const SecurityCheckContent = ({
    // TODO change to onConfirm, abstract away the !shouldAuthenticateSelectedDevice
    ...
    const handleContinueButtonClick = () => {
        ...
        if (!shouldAuthenticateSelectedDevice) {
            goToSuiteOrNextDevice();
            console.log('GO TO SUITE FROM MDC');
        } else {
            console.log('GO TO DAC');
        }
    };
...
export const SecurityCheck = () => {
    ...
    // If there are multiple devices connected that are eligible for either Manual Device Check or Device Authenticity check,
    // check all of them before continuing to Suite.
    const goToSuiteOrNextDevice = useCallback(() => {
        ...
        if (nextDeviceToCheck !== undefined) {
            ...
            console.log('GO TO SUITE, NO NEXT DEVICE');
            goToSuite();
        }
    }, [allDevicesRequiringSecurityCheck, checkedDevices, dispatch, goToSuite, selectedDeviceId]);

    // HACK, I SHOULDN'T NEED THAT
    // useEffect(() => {
    //     if (!shouldDisplayManualDeviceCheck && !shouldDisplayDeviceAuthenticityCheck) {
    //         goToSuiteOrNextDevice();
    //     }
    // }, [
    //     goToSuiteOrNextDevice,
    //     shouldDisplayDeviceAuthenticityCheck,
    //     shouldDisplayManualDeviceCheck,
    // ]);
    ...
    // HACK, I SHOULDN'T NEED THAT
    // if (!shouldDisplayManualDeviceCheck) {
    //     return null;
    // }
    ...
    return (
        <Card paddingType="large">
            <SecurityCheckContent
                ...
                shouldAuthenticateSelectedDevice={shouldDisplayDeviceAuthenticityCheck}
            />
        </Card>
    );
};
