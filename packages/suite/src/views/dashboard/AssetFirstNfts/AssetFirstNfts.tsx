...
import { Card, Collapsible, Row, SubTabs, Table, Text } from '@trezor/components';
...
export const AssetFirstNfts = ({ deviceState }: AssetFirstNftsProps) => {
    ...
    return (
        <Card paddingType="normal" data-testid="@dashboard/asset-first-nfts">
            <Collapsible defaultIsOpen>
                ...
                <Collapsible.Content>
                    <Row justifyContent="space-between" alignItems="center" margin={{ top: 16 }}>
