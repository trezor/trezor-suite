...
export const AccountEmpty = ({ account }: AccountEmptyProps) => {
    ...
    const symbolTicker = account.symbol.toUpperCase();
            ...
            actions={[
                {
                    ...
                    children: (
                        <Translation id="TR_RECEIVE_NETWORK" values={{ network: symbolTicker }} />
                    ),
                },
                {
                    ...
                    children: (
                        <Translation id="TR_BUY_NETWORK" values={{ network: symbolTicker }} />
                    ),
                },
            ]}
        />
