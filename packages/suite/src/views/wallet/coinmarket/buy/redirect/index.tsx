...
import { useCoinmarketBuyRedirect } from '@wallet-hooks/useCoinmarketBuyRedirect';
...
const BuyRedirect = () => {
    const { redirectToOffers, redirectToDetail } = useCoinmarketBuyRedirect();
