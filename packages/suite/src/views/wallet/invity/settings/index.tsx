...
const CoinmarketSavingsRecoverySettings = ({ selectedAccount }: InvityLayoutProps) => {
    ...
    return (
        <InvityLayout selectedAccount={selectedAccount}>
            <Wrapper>
                ...
                <Right>
                    <Header>
                        <Translation id="TR_INVITY_SETTINGS_HEADER" />
                    </Header>
                    <Description>
                        <Translation id="TR_INVITY_SETTINGS_DESCRIPTION" />
                    </Description>
                    ...
                    <StyledIframe
                        ...
                        src={invityAPI.getSettingsPageSrc(theme.THEME)}
...
export default withSelectedAccountLoaded(CoinmarketSavingsRecoverySettings, {
    title: 'TR_NAV_INVITY',
