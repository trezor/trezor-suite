...
type TradingDetailAssetRowProps = {
    account?: Account;
...
export const TradingDetailAssetRow = ({
    account,
    label,
    currency,
    amount,
    ...
    const {
        ...
        contractAddress,
        symbol,
    } = getAssetOptionFromCryptoId(currency);
                ...
                <Row gap={8} justifyContent="space-between">
                    <Row gap={8} alignItems="center">
                        ...
                        <Column alignItems="start">
                            <Text data-testid={`${testIdPrefix}-asset-name`}>{displayName}</Text>
                            {showNetwork && (
                                <Text
                                    intent="neutral"
                                    priority="secondary"
                    ...
                    <Column alignItems="flex-end">
                        <Text typographyStyle="body-md-strong" as="div">
                            <TradingCryptoAmount
                                amount={amount}
                                cryptoId={currency}
