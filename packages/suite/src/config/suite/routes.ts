...
const routes = [
    ...
    {
        name: 'wallet-coinmarket-savings-sign-in',
        pattern: '/accounts/coinmarket/savings/sign-in',
        app: 'wallet',
        params: walletParams,
    },
    {
    ...
    {
        name: 'wallet-coinmarket-savings-registration-successful',
        pattern: '/accounts/coinmarket/savings/registration-successful',
        app: 'wallet',
        params: walletParams,
    },
    {
