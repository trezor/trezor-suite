...
const routes = [
    ...
    {
        name: 'wallet-invity-registration',
        pattern: '/accounts/invity/registration',
        app: 'wallet',
        params: walletParams,
    },
    {
    ...
    {
        name: 'wallet-invity-account-verified',
        pattern: '/accounts/invity/account-verified',
        app: 'wallet',
        params: walletParams,
    },
    {
    ...
    {
        name: 'wallet-invity-kyc-start',
        pattern: '/accounts/invity/kyc-start',
        app: 'wallet',
        params: walletParams,
    },
    {
