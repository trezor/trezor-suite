...
export default defineMessages({
    ...
    TR_ONBOARDING_TREZOR_WILL_DISPLAY_BACKUP: {
        defaultMessage:
            "Trezor will now show your wallet backup. Write it down precisely in exact order and keep it safe, it's the only way to recover your funds.",
        id: 'TR_ONBOARDING_TREZOR_WILL_DISPLAY_BACKUP',
    },
    TR_ONBOARDING_BACKUP_SUBHEADING: {
        defaultMessage:
            "Wallet backup is a list of words generated by your Trezor. Please write it down precisely and keep it safe, it's the only way to recover your funds.",
    ...
    TR_YOUR_WALLET_IS_ALMOST_READY_DESCRIPTION: {
        defaultMessage:
            "Great job! Now let's make a wallet backup, the only way to recover the wallet if needed.",
    ...
    TR_ONBOARDING_WILL_CREATE_BACKUP_TYPE: {
        ...
        defaultMessage: 'Trezor will create your wallet based on<br></br>the selected backup type.',
    },
    ...
    TR_ONBOARDING_SEED_TYPE_SINGLE_SEED_DESCRIPTION: {
        ...
        defaultMessage: 'Allows you to upgrade to multi-share later.',
    },
    ...
    TR_ONBOARDING_SEED_TYPE_ADVANCED_DESCRIPTION: {
        ...
        defaultMessage: 'Creates multiple pieces of backup.',
    },
    ...
    TR_ONBOARDING_BACKUP_CATEGORY_20_WORD_BACKUPS: {
        ...
        defaultMessage: '20 words backups',
    },
    TR_ONBOARDING_BACKUP_TYPE_UPGRADABLE_TO_MULTI: {
        id: 'TR_ONBOARDING_BACKUP_TYPE_UPGRADABLE_TO_MULTI',
        defaultMessage: 'Upgradable to Multi-share',
    },
    TR_ONBOARDING_BACKUP_TYPE_12_WORDS_DEFAULT_NOTE: {
        id: 'TR_ONBOARDING_BACKUP_TYPE_12_WORDS_DEFAULT_NOTE',
        defaultMessage:
            "We've chosen this strong basic backup type that fits your device's backup card, making it easy to record accurately.",
    },
    TR_ONBOARDING_BACKUP_OLDER_BACKUP_TYPES: {
        id: 'TR_ONBOARDING_BACKUP_OLDER_BACKUP_TYPES',
        defaultMessage:
            'Basic backup types <br></br>These don’t allow to upgrade to multi-share later',
    },
    TR_ONBOARDING_BACKUP_LEGACY_WARNING: {
        id: 'TR_ONBOARDING_BACKUP_LEGACY_WARNING',
        defaultMessage:
            'This backup type won’t allow you to upgrade to multi-share backup later on. To allow for backup upgrade, use 20 words backup.',
    },
    TR_ONBOARDING_BACKUP_SHAMIR_WARNING: {
        id: 'TR_ONBOARDING_BACKUP_SHAMIR_WARNING',
        defaultMessage:
            "This backup allows for <strong>future upgrades</strong> but includes 20 words, which <strong>won't fit</strong> on the 12-word <strong>backup card packaged with your device</strong>. Please write them in <strong>numbered order</strong> on durable paper and <strong>avoid storing them digitally</strong>.",
    },
