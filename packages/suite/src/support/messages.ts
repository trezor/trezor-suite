...
export default defineMessages({
    ...
    TR_CLEAR_STORAGE_DESCRIPTION: {
        ...
        defaultMessage:
            'Reset the app to its default settings as a recommended first step for troubleshooting. Trezo Suite will automatically restart once the process is complete.',
    },
