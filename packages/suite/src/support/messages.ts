...
export default defineMessages({
    ...
    TR_ADD_TOKEN_NOTE: {
        ...
        defaultMessage:
            "You don't have to add desired tokens manually. Feel free to use the Receive button in the top right corner and have the desired token sent to the Receive address generated by your Trezor. Make sure the token will be sent from the same network to receive it right here.",
    },
    TR_ADD_TOKEN_LABEL: {
