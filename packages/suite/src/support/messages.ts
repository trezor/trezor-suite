...
export default defineMessages({
    ...
    TR_CHECK_RECOVERY_SEED_DESC_TT: {
        ...
        defaultMessage:
            'Your recovery seed (wallet backup) is entered using the Trezor Model T touchscreen. This avoids exposing sensitive information to a potentially insecure computer or web browser.',
        dynamic: true,
    },
    ...
    TR_RECEIVING_SYMBOL: {
        ...
        defaultMessage:
            'Receive {multiple, select, true {multiple tokens} false {{symbol}} other {{symbol}}}',
    },
    TR_RECEIVED_SYMBOL: {
