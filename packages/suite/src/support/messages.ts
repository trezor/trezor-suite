...
export default defineMessages({
    ...
    TR_ADVANCED_RECOVERY_TEXT: {
        ...
        defaultMessage:
            "Spell each word of your wallet backup using the keypad below, according to where the letters are shown on your Trezor's screen.",
    },
    ...
    TR_BACKUP_CHECKBOX_1_DESCRIPTION: {
        ...
        defaultMessage:
            'Make sure you recorded each word in the exact order it was given to you. Keep your wallet backup card dry and free from smudges.',
    },
