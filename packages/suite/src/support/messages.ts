...
export default defineMessages({
    ...
    TR_BIO_AUTH_FAILED: {
        defaultMessage: 'Access authentication failed',
    ...
    TR_RECOVERY_TYPES_DESCRIPTION: {
        defaultMessage:
            'Both methods are secure. Choose advanced recovery if you prefer entering your wallet backup on your Trezor’s screen—it just takes longer.',
        description:
