import type { BlockbookTransaction } from '@trezor/blockchain-link-types/src/blockbook';
import { arrayDistinct, arrayToDictionary } from '@trezor/utils';

import type { ElectrumAPI, HistoryTx, TransactionVerbose, TxCoinbase, TxIn, TxOut } from '../types';
