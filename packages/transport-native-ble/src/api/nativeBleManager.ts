...
export const NUS_SERVICE_UUID = '8c000001-a59b-4d58-a9ad-073df69fa1b1';
...
class NativeBleManager {
    ...
    public getStatus = () => this.currentStatus;
    ...
    public getAllConnectedDevices = async () => this.appConnectedDevices.map(d => d.bleDevice);

    public findDevice = (deviceId: string) =>
        this.appConnectedDevices.find(d => d.bleDevice.id === deviceId);
