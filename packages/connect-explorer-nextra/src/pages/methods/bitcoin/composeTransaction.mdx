...
export const paramDescriptions = {
    outputs: 'of output objects described [below](#accepted-output-objects)',
    ...
    account:
        'containing essential data, partial result of [getAccountInfo method](getAccountInfo.md#result)',
    feeLevels:
        'of objects. set of requested variants, partial result of `blockchainEstimateFee method`',
    baseFee:
