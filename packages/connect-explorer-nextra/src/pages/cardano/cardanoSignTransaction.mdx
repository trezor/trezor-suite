...
import { CardanoSignTransaction } from '@trezor/connect/src/types/api/cardano';

<ApiPlayground options={[{ method: 'cardanoSignTransaction', schema: CardanoSignTransaction }]} />
...
<ParamsTable schema={CardanoSignTransaction} />
