...
![connect schema when used in node](/schema-connect.jpg)
...
![connect schema when used on web](/schema-connect-web.jpg)
...
![connect schema when used in webextension](/schema-connect-webextension.jpg)
