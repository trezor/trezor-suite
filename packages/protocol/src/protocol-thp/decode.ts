...
const readHandshakeInitResponse = ({ payload }: ThpMessage): ThpMessageResponse => {
...
const readHandshakeCompletionResponse = ({ payload, thpState }: ThpMessage): ThpMessageResponse => {
