// https://raw.githubusercontent.com/C2SP/wycheproof/2196000605e45d91097147c9c71f26b72af58003/testvectors/x25519_test.json
export const curve25519fixtures = [
    {
        tcId: 1,
    ...
    {
        tcId: 2,
        description: 'public key on twist',
    ...
    {
        tcId: 102,
        description: 'RFC 8037, Section A.6',
    ...
    {
        tcId: 103,
        description: 'edge case for shared secret',
    ...
    {
        tcId: 171,
        description: 'special case for DA in multiplication by 2',
    ...
    {
        tcId: 175,
        description: 'special case for x_2 in multiplication by 2',
    ...
    {
        tcId: 181,
        description: 'special case for AA in multiplication by 2',
    ...
    {
        tcId: 185,
        description: 'special case for BB in multiplication by 2',
    ...
    {
        tcId: 189,
        description: 'special case for D in multiplication by 2',
    ...
    {
        tcId: 202,
        description: 'special case for z_2 in multiplication by 2',
    ...
    {
        tcId: 210,
        description: 'special case for A in multiplication by 2',
    ...
    {
        tcId: 216,
        description: 'special case for B in multiplication by 2',
    ...
    {
        tcId: 222,
        description: 'special case for C in multiplication by 2',
    ...
    {
        tcId: 226,
        description: 'special case for CB in multiplication by 2',
    ...
    {
        tcId: 229,
        description: 'special case for x_2 in multiplication by 3',
    ...
    {
        tcId: 235,
        description: 'special case for z_2 in multiplication by 3',
    ...
    {
        tcId: 238,
        description: 'special case for DA - CB in multiplication by 3',
    ...
    {
        tcId: 240,
        description: 'special case for BB in multiplication by 3',
    ...
    {
        tcId: 244,
        description: 'special case for E in multiplication by 3',
    ...
    {
        tcId: 251,
        description: 'special case for AA in multiplication by 3',
    ...
    {
        tcId: 259,
        description: 'special case for D in multiplication by 4',
    ...
    {
        tcId: 267,
        description: 'special case for E in multiplication by 4',
    ...
    {
        tcId: 271,
        description: 'special case for B in multiplication by 4',
    ...
    {
        tcId: 279,
        description: 'special case for BB in multiplication by 4',
    ...
    {
        tcId: 284,
        description: 'special case for x_2 in multiplication by 4',
    ...
    {
        tcId: 294,
        description: 'special case for DA + CB in multiplication by 4',
    ...
    {
        tcId: 297,
        description: 'special case for A in multiplication by 4',
    ...
    {
        tcId: 306,
        description: 'special case for C in multiplication by 4',
    ...
    {
        tcId: 310,
        description: 'special case for z_2 in multiplication by 4',
    ...
    {
        tcId: 313,
        description: 'special case for CB in multiplication by 4',
    ...
    {
        tcId: 317,
        description: 'special case for AA in multiplication by 4',
    ...
    {
        tcId: 324,
        description: 'special case for DA in multiplication by 4',
    ...
    {
        tcId: 325,
        description: 'special case for z_2 in multiplication by 5',
    ...
    {
        tcId: 331,
        description: 'special case for E in multiplication by 5',
    ...
    {
        tcId: 336,
        description: 'special case for AA in multiplication by 5',
    ...
    {
        tcId: 340,
        description: 'special case for DA - CB in multiplication by 5',
    ...
    {
        tcId: 343,
        description: 'special case for BB in multiplication by 5',
    ...
    {
        tcId: 346,
        description: 'special case for x_2 in multiplication by 5',
    ...
    {
        tcId: 349,
        description: 'special case for C in multiplication by 6',
    ...
    {
        tcId: 354,
        description: 'special case for CB in multiplication by 6',
    ...
    {
        tcId: 362,
        description: 'special case for x_2 in multiplication by 6',
    ...
    {
        tcId: 369,
        description: 'special case for DA - CB in multiplication by 6',
    ...
    {
        tcId: 381,
        description: 'special case for z_2 in multiplication by 6',
    ...
    {
        tcId: 385,
        description: 'special case for D in multiplication by 6',
    ...
    {
        tcId: 389,
        description: 'special case for DA in multiplication by 6',
    ...
    {
        tcId: 393,
        description: 'special case for z_2 in multiplication by 7',
    ...
    {
        tcId: 398,
        description: 'special case for BB in multiplication by 7',
    ...
    {
        tcId: 401,
        description: 'special case for E in multiplication by 7',
    ...
    {
        tcId: 405,
        description: 'special case for AA in multiplication by 7',
    ...
    {
        tcId: 412,
        description: 'special case for x_2 in multiplication by 7',
    ...
    {
        tcId: 421,
        description: 'special case for DA - CB in multiplication by 7',
    ...
    {
        tcId: 425,
        description: 'special case for D in multiplication by 8',
    ...
    {
        tcId: 428,
        description: 'special case for DA + CB in multiplication by 8',
    ...
    {
        tcId: 436,
        description: 'special case for AA in multiplication by 8',
    ...
    {
        tcId: 439,
        description: 'special case for z_2 in multiplication by 8',
    ...
    {
        tcId: 442,
        description: 'special case for B in multiplication by 8',
    ...
    {
        tcId: 445,
        description: 'special case for C in multiplication by 8',
    ...
    {
        tcId: 449,
        description: 'special case for x_2 in multiplication by 8',
    ...
    {
        tcId: 463,
        description: 'special case for E in multiplication by 8',
    ...
    {
        tcId: 477,
        description: 'special case for CB in multiplication by 8',
    ...
    {
        tcId: 479,
        description: 'special case for BB in multiplication by 8',
    ...
    {
        tcId: 483,
        description: 'special case for A in multiplication by 8',
    ...
    {
        tcId: 485,
        description: 'special case for DA in multiplication by 8',
    ...
    {
        tcId: 487,
        description: 'special case for AA in multiplication by 9',
    ...
    {
        tcId: 494,
        description: 'special case for DA - CB in multiplication by 9',
    ...
    {
        tcId: 495,
        description: 'special case for z_2 in multiplication by 9',
    ...
    {
        tcId: 501,
        description: 'special case for E in multiplication by 9',
    ...
    {
        tcId: 504,
        description: 'special case for x_2 in multiplication by 9',
    ...
    {
        tcId: 507,
        description: 'special case for BB in multiplication by 9',
    ...
    {
        tcId: 511,
        description: 'private key == -1 (mod order)',
    ...
    {
        tcId: 512,
        description: 'private key == 1 (mod order) on twist',
    ...
    {
        tcId: 513,
        description: 'special case private key',
...
export const elligator2fixtures = [
    [
