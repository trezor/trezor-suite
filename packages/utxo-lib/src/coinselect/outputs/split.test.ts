import type { CoinSelectInput, CoinSelectOptions, CoinSelectOutput } from '../../types';
import * as utils from '../__fixtures__/test.utils';
import { INPUT_SCRIPT_LENGTH, OUTPUT_SCRIPT_LENGTH } from '../coinselectUtils';
import fixtures from './__fixtures__/split';
