export const fixtures = {
    valid: [
        {
            ...
            expected: {
                ...
                output: 'OP_SSTXCHANGE OP_DUP OP_HASH160 751e76e8199196d454941c45d1b3a323f1433bd6 OP_EQUALVERIFY OP_CHECKSIG',
            },
        },
        {
    ...
    invalid: [
        ...
        },
        {
            ...
            exception: 'sstxchange output is invalid',
            arguments: {
        ...
        },
        {
            ...
            exception: 'sstxchange output is invalid',
            arguments: {
                output: 'OP_SSTXCHANGE OP_DUP OP_HASH160 751e76e8199196d454941c45d1b3a323f1433b OP_EQUALVERIFY OP_CHECKSIG',
            },
        },
        {
        ...
        },
        {
            ...
            arguments: {
                network: 'decred',
                address: 'DsbeB3ap3RiS4CLpgd1yXMSKLdrNMppeBE9',
                output: 'OP_SSTXCHANGE OP_DUP OP_HASH160 ffffffffffffffffffffffffffffffffffffffff OP_EQUALVERIFY OP_CHECKSIG',
            },
        },
        {
