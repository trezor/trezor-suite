import { BaseWebsocket } from '@trezor/blockchain-link';
import type {
...
export class BlockbookAPI extends BaseWebsocket<BlockbookEvents> {
    ...
    getCurrentFiatRates(payload: GetCurrentFiatRatesParams) {
    ...
    getFiatRatesForTimestamps(payload: GetFiatRatesForTimestampsParams) {
        return this.send('getFiatRatesForTimestamps', payload);
    }

    getFiatRatesTickersList(payload: GetFiatRatesTickersListParams) {
