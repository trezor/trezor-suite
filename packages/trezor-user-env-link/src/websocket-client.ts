...
import type { WebsocketResponse as WebsocketResponseData } from '@trezor/websocket-client';
import { WebsocketClient as WebsocketClientBase } from '@trezor/websocket-client';
