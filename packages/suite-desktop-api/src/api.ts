...
export interface InvokeChannels {
    ...
    'safe-storage/decrypt': (params: { value: string }) => Result<string, EncryptionUnavailable>;
    'safe-storage/encrypt': (params: { value: string }) => Result<string, EncryptionUnavailable>;
}
