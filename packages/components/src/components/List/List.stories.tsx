...
export const List: StoryObj<typeof ListComponent> = {
    render: props => (
        <ListComponent {...props}>
            <ListComponent.Item bulletComponent={<IconStories name="butterfly" {...iconProps} />}>
            ...
            <ListComponent.Item bulletComponent={<IconStories name="compass" {...iconProps} />}>
            ...
            <ListComponent.Item bulletComponent={<IconStories name="bell" {...iconProps} />}>
