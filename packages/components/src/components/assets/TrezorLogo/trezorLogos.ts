...
export const LOGOS: { [key: string]: any } = {
    ...
    SUITE: require('../../../images/trezor_logo_suite.svg'),
    SUITE_SQUARE: require('../../../images/trezor_logo_suite_square.svg'),
    SUITE_COMPACT: require('../../../images/trezor_logo_suite_compact.svg'),
};
