...
import type { GradientOverlayProps } from './GradientOverlay';
import { GradientOverlay as GradientOverlayComponent } from './GradientOverlay';
...
const meta: Meta<typeof GradientOverlayComponent> = {
