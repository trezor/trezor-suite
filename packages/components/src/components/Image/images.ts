...
export const IMAGES = {
    ...
    DASHBOARD_PROMO_BANNER_DEFI_YIELD: 'dashboard-promo-banner/defi-yield.webp',
    DASHBOARD_PROMO_BANNER_DEFI_YIELD_2x: 'dashboard-promo-banner/defi-yield@2x.webp',
