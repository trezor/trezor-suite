...
export const SVG_IMAGES = {
    ...
    DEVICE_CONFIRM_TREZOR_T3B1: 'device-confirm-trezor-t2b1.svg',
...
export const PNG_IMAGES = {
    ...
    DONT_DISCONNECT_TREZOR_T3B1: 'dont-disconnect-trezor-t2b1.png',
    DONT_DISCONNECT_TREZOR_T3B1_2x: 'dont-disconnect-trezor-t2b1@2x.png',
    ...
    TREZOR_T3B1: 'trezor-t2b1.png',
    TREZOR_T3B1_2x: 'trezor-t2b1@2x.png',
    ...
    TREZOR_T3B1_LARGE: 'trezor-t2b1-large.png',
    TREZOR_T3B1_LARGE_2x: 'trezor-t2b1-large@2x.png',
    ...
    TREZOR_T3B1_GHOST: 'trezor-t2b1-ghost.png',
    TREZOR_T3B1_GHOST_2x: 'trezor-t2b1-ghost@2x.png',
