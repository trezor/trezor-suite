...
import {
    type SignSolanaStakingRejectValue,
    type SolanaAccount,
    type SolanaStakingComposeRejectValue,
    type SolanaStakingType,
...
const getSolanaUserAgent = () => `Trezor Suite Lite ${getSuiteVersion()}`;
...
const resolveSolanaStakingContext = (
    ...
    | { ok: true; account: SolanaAccount; blockchainUrl: string }
    ...
    return { ok: true, account: account as SolanaAccount, blockchainUrl };
};

export const composeSolanaStakingTransactionFeeLevelsNativeThunk = createThunk<
    PrecomposedLevels | undefined,
    { accountKey: AccountKey; stakeType: SolanaStakingType; amount: string },
...
export const signSolanaStakingTransactionNativeThunk = createThunk<
    ...
    { rejectValue: SignSolanaStakingRejectValue }
>(
