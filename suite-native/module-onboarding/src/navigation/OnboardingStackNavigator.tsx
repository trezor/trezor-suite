...
import type { OnboardingStackParamList } from '@suite-native/navigation';
import { OnboardingStackRoutes, stackNavigationOptionsConfig } from '@suite-native/navigation';
