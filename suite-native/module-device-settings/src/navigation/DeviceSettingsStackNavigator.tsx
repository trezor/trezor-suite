...
import type { DeviceSettingsStackParamList } from '@suite-native/navigation';
import { DeviceSettingsStackRoutes, stackNavigationOptionsConfig } from '@suite-native/navigation';
