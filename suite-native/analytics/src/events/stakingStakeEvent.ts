...
export const stakingStakeEvent: EventDef<Attributes, EventType.StakingStake> = {
    ...
    descriptionTrigger: 'User navigates through the staking flow to stake cryptocurrency, with tracking at each step including educational modals and form submission',
    changelog: [{ version: '26.4.1', notes: 'added' }],
    attributes: {
        action: {
            changelog: [{ version: '26.4.1', notes: 'added' }],
            description: 'User action: "continue" to proceed through the flow, "cancel" to exit, "close" to dismiss',
        },
        step: {
            changelog: [{ version: '26.4.1', notes: 'added' }],
        ...
        networkSymbol: {
            changelog: [{ version: '26.4.1', notes: 'added' }],
            description: 'The blockchain network symbol for which staking is being performed (e.g., "eth", "sol", "ada")',
        },
        currency: {
            changelog: [{ version: '26.4.1', notes: 'added' }],
