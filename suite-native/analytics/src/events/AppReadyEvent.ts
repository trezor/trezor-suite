...
import { AppColorScheme } from '@suite-native/theme';
...
export const appReadyEvent: EventDef<Attributes, EventType.AppReady> = {
    ...
    descriptionTrigger: 'On the application start or when the app onboarding is done.',
    changelog: [
    ...
    attributes: {
        ...
        isBiometricsEnabled: {
            changelog: [{ version: '24.4.1', notes: 'added' }],
            description: 'Is biometrics enabled?',
        },
