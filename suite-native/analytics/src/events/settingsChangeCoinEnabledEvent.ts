...
> = {
    ...
    attributes: {
        symbol: {
            changelog: [{ version: '24.9.1', notes: 'added' }],
            description: 'The network symbol of the cryptocurrency being enabled or disabled (e.g., "btc", "eth", "ada")',
        },
        value: {
            changelog: [{ version: '24.9.1', notes: 'added' }],
            description: 'true if the cryptocurrency network is enabled (visible in app), false if disabled (hidden from app)',
        },
    },
};
