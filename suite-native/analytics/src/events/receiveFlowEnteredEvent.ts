...
export const receiveFlowEnteredEvent: EventDef<Attributes, EventType.ReceiveFlowEntered> = {
    ...
    descriptionTrigger: 'User enters the receive cryptocurrency flow to generate a receiving address',
    ...
    attributes: {
        ...
        tokenSymbol: {
            description: 'The symbol of the token for which the user is generating a receive address, only present when receiving a specific token rather than the native asset',
            changelog: [{ version: '26.2.2', notes: 'added' }],
        },
        tokenContract: {
            description: 'The contract address of the token for which the user is generating a receive address, only present for non-native tokens',
            changelog: [{ version: '26.2.2', notes: 'added' }],
        },
    },
};
