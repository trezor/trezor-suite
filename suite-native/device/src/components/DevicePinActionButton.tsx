...
const actionConfigMap = {
    enable: {
        param: false,
        successMessageKey: 'deviceSettings.pinProtection.actions.enable.success',
        canceledMessageKey: 'deviceSettings.pinProtection.actions.enable.canceled',
    },
    change: {
        param: undefined,
        successMessageKey: 'deviceSettings.pinProtection.actions.change.success',
        canceledMessageKey: 'deviceSettings.pinProtection.actions.change.canceled',
    },
    disable: {
        param: true,
        successMessageKey: 'deviceSettings.pinProtection.actions.disable.success',
        canceledMessageKey: 'deviceSettings.pinProtection.actions.disable.canceled',
    },
...
export const DevicePinActionButton = ({ children, type, colorScheme }: ActionButtonProps) => {
    ...
    const changePin = useCallback(async () => {
        ...
        if (result.success) {
            ...
            showError('deviceSettings.pinProtection.errors.pinInvalid', changePin);
