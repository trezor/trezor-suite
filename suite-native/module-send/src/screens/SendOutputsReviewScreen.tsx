...
import {
    ...
    getTransactionReviewNetworkOptions,
...
export const SendOutputsReviewScreen = ({ route }: SendOutputsReviewScreenProps) => {
    ...
    const { isSummaryItemEnabled, isSlidingOverlayEnabled } = getTransactionReviewNetworkOptions(
        account?.networkType,
    );
    ...
    return (
        <TransactionReviewScreen
            ...
            isSummaryItemEnabled={isSummaryItemEnabled}
            isSlidingOverlayEnabled={isSlidingOverlayEnabled}
