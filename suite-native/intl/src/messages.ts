    ...
    moduleSettings: {
        ...
        appLog: {
            sensitiveDataToggle: {
                ...
                subtitle:
                    'Enabling this option includes sensitive data including balance, transaction IDs, device labels, device ID, and public addresses in the app log. If your issue is unrelated, disable it.',
            },
