...
import { FormattersExperimentScreen } from '@suite-native/formatters-experiment';
...
export const RootStackNavigator = () => (
    <RootStack.Navigator
        ...
        initialRouteName={RootStackRoutes.FormattersExperiment}
    ...
    >
        ...
        <RootStack.Screen
            name={RootStackRoutes.FormattersExperiment}
            component={FormattersExperimentScreen}
        />
        <RootStack.Screen
        ...
        />
        <RootStack.Screen name={RootStackRoutes.BootloaderMode} component={BootloaderModeScreen} />
