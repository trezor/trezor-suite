...
import { type PreloadedState, renderWithStoreProviderAsync, screen } from '@suite-native/test-utils';
...
describe('EmptyHomeRenderer', () => {
    ...
    const expectEmptyPortfolioCrossroadsState = () => {
        ...
        expect(getByText('Manage your coins with your Trezor connected.')).toBeTruthy();
    };
