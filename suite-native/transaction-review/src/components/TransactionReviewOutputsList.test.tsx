...
describe('TransactionReviewOutputsList', () => {
    ...
    it('should not render the default summary card when it is disabled', async () => {
        const { queryByText, getByText } = await renderList({ isSummaryItemEnabled: false });
    ...
    describe('sliding footer overlay', () => {
        ...
        it('should not render when it is disabled', async () => {
            const { queryByTestId } = await renderList({ isSlidingOverlayEnabled: false });
