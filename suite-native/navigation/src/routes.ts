export enum RootStackRoutes {
    ...
    StakeTransactionDataReview = 'StakeTransactionDataReview',
    StakeTransactionComplete = 'StakeTransactionComplete',
    ClaimReview = 'ClaimReview',
    ClaimTransactionDataReview = 'ClaimTransactionDataReview',
    ClaimTransactionComplete = 'ClaimTransactionComplete',
    DevUtils = 'DevUtils',
    ...
    UnstakeTransactionComplete = 'UnstakeTransactionComplete',
