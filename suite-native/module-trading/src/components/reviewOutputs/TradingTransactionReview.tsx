...
import { TradingTransactionReviewSummaryCard } from './TradingTransactionReviewSummaryCard';
...
import { useTradingTransactionReviewOutputs } from '../../hooks/useTradingTransactionReviewOutputs';

export type TradingTransactionReviewProps = UseTradingOutputsReviewScreenControlsProps &
...
export const TradingTransactionReview = memo(
    ({
        accountKey,
        tokenContract,
        orderId,
        ...
        const tradingTransactionReviewOutputs = useTradingTransactionReviewOutputs({
            accountKey,
            tokenContract,
        ...
        const { isSummaryItemEnabled, isSlidingOverlayEnabled } =
            getTransactionReviewNetworkOptions(account?.networkType);
        ...
        return (
            <TransactionReviewScreen
                ...
                isSendButtonDisabled={!isTransactionSendConsentRequested}
                ...
                outputTitleOverride={tradingTransactionReviewOutputs.getOutputTitle}
                outputOverride={tradingTransactionReviewOutputs.getOutputValue}
            />
        );
    },
);
