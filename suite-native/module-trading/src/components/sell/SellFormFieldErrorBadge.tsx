...
import type { FiatRatesRootState, WalletSettingsRootState } from '@suite-common/wallet-core';
...
import { selectAmountInBaseFiatCurrency } from '@suite-native/trading-state';
import type { SellFormValues, TradeableAsset } from '@suite-native/trading-types';
