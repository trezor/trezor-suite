...
type HowYieldWorksScreenContentProps = {
    yieldFlowData: ResolvedYieldFlowData;
};

export const HowYieldWorksScreenContent = ({ yieldFlowData }: HowYieldWorksScreenContentProps) => {
        ...
        <Screen header={<ScreenHeader closeActionType="back" />}>
            <VStack flex={1} justifyContent="space-between">
                ...
                <VStack spacing="sp16">
                    ...
                    <Button
                        onPress={handleNavigateToYieldConsents}
                        isDisabled={!route.params.isInfoOnly && isDepositDisabled}
                    >
                        <Translation
                            id={
