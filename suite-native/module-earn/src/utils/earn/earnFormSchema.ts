...
export const earnFormValidationSchema = (networkConfigDeps: NetworkConfigDeps) =>
    yup.object({
        amount: yup
            .string()
...
export type EarnFormValues = yup.InferType<ReturnType<typeof earnFormValidationSchema>>;
