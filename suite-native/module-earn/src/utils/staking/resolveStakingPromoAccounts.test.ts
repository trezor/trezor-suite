...
describe('resolveStakingPromoAccounts', () => {
    it('marks a network without a mobile staking flow as desktop only', () => {
        ...
        expect(resolveStakingPromoAccounts(networkConfigDeps, { symbol: 'trx', accounts })).toEqual(
            {
                isDesktopOnly: true,
            },
        );
    ...
    it('returns every account of a network with a mobile staking flow', () => {
        ...
        expect(resolveStakingPromoAccounts(networkConfigDeps, { symbol: 'eth', accounts })).toEqual(
            {
                isDesktopOnly: false,
    ...
    it('returns only the delegated Cardano accounts', () => {
        ...
        expect(resolveStakingPromoAccounts(networkConfigDeps, { symbol: 'ada', accounts })).toEqual(
            {
                isDesktopOnly: false,
    ...
    it('returns a Cardano account that is delegated but emptied', () => {
        ...
        expect(
            resolveStakingPromoAccounts(networkConfigDeps, {
                symbol: 'ada',
