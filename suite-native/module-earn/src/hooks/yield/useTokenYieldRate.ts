...
import { getBestPromotedRate, isEarnPromoSymbol } from '../../utils/earn/promotedRateUtils';
import {
    type YieldRateLabelType,
    getYieldRateLabelType,
} from '../../utils/yield/getYieldRateLabelType';
import { useStakingRate } from '../staking/useStakingRate';
