...
export const messages = defineMessages({
    ...
    TR_SKIP_BACKUP_DESCRIPTION: {
        defaultMessage:
            'A wallet backup lets you recover your funds if your Trezor gets lost, stolen, or damaged. Without a wallet backup, you could lose access to your assets permanently.',
    ...
    TR_BIO_AUTH_NOT_AVAILABLE_TOOLTIP_CONTENT: {
        ...
        defaultMessage:
            'Biometrics isn’t currently available. Try restarting your phone or computer, or open Trezor Suite on another device. If that doesn’t help, reinstall the app and reconnect your Trezor.',
    },
    ...
    TR_EXPERIMENTAL_TRON_VIEW_ONLY_DESCRIPTION: {
        ...
        defaultMessage:
            "Update to the latest firmware to enable the Tron Network and view your balance, tokens, charts, and transaction history. This feature is in preview and may contain bugs. Sending funds from the wallet isn't supported yet. Full support is coming soon.",
    },
