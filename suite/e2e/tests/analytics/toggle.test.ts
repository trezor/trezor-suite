...
test.describe(
    ...
    () => {
        ...
        test(
            'should respect disabled analytics in onboarding with following enabling in settings',
        ...
        test(
            'should respect enabled analytics in onboarding with following disabling in settings',
            { annotation: createTestAnnotation({ stream: TestStream.Growth }) },
            async ({
                device,
                analytics,
