...
export const selectTradeServerEnvironment = (state: SuiteSettingsRootState) =>
    state.suiteSettings.debug.tradeServerEnvironment;
...
export const selectIsAssetFirstHomeTableEnabled = (state: SuiteSettingsRootState) =>
    state.suiteSettings.debug.isAssetFirstHomeTableEnabled;
