...
const handleRequestWebUsbDevice = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.stopPropagation();
...
const WebUsbButton = (props: WebUsbButtonProps) => (
    <Button
        {...props}
...
export const FirmwareReconnectDevicePrompt = ({
    onClose,
    onSuccess,
