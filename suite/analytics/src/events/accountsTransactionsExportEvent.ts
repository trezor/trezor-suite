...
> = {
    ...
    descriptionTrigger: 'User exports account transactions in a selected format (PDF, CSV, or JSON)',
    changelog: [{ version: '1.23.0', notes: 'added' }],

    attributes: {
        symbol: {
            description: 'The blockchain network or asset symbol for which transactions are being exported',
            changelog: [{ version: '1.23.0', notes: 'added' }],
        },
        format: {
