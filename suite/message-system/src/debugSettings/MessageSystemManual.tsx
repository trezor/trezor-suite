...
const FIELDS = {
    message: [
        {
            field: 'id',
            required: <Icon as={CheckCircleFilledIcon} intent="brand" />,
        ...
        {
            field: 'headline',
            required: <Icon as={XCircleFilledIcon} intent="critical" />,
        ...
        },
        {
            ...
            required: (
                <Tooltip content="only for banner and context">
                    <Icon as={CheckCircleFilledIcon} intent="warning" />
                </Tooltip>
            ),
    ...
    conditions: [
        {
            field: 'duration',
            required: <Icon as={CheckCircleFilledIcon} intent="warning" />,
