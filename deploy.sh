...
wget "https://gitlab.com/satoshilabs/trezor/trezor-suite/-/jobs/artifacts/deploy-experiments/download?job=landing-page%20deploy%20staging" -O ./combined-build/suite-web.zip
