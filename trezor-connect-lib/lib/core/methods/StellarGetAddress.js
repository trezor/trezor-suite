...
var StellarGetAddress =
/*#__PURE__*/
function (_AbstractMethod) {
  (0, _inheritsLoose2.default)(StellarGetAddress, _AbstractMethod);
  ...
  function StellarGetAddress(message) {
    ...
    _this.firmwareRange = (0, _paramsValidator.getFirmwareRange)(_this.name, (0, _CoinInfo.getMiscNetwork)('Stellar'), _this.firmwareRange); // create a bundle with only one batch if bundle doesn't exists
    ...
    if (bundle.length === 1) {
      _this.info = "Export Stellar address for account #" + ((0, _pathUtils.fromHardened)(_this.params[0].path[2]) + 1);
    } else {
...
exports.default = StellarGetAddress;