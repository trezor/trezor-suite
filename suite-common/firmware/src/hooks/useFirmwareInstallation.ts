...
import type { ButtonRequest, FirmwareStatus, TrezorDevice } from '@suite-common/suite-types';
...
import type { FirmwareUpdateProps } from '../firmwareThunks';
import { firmwareUpdate as firmwareUpdateThunk } from '../firmwareThunks';
