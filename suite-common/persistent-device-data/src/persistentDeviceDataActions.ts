...
import { PERSISTENT_DEVICE_DATA_MODULE_PREFIX } from './persistentDeviceDataConstants';
...
const forgetDevicePersistentData = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/forgetDevicePersistentData`,
    (payload: { deviceId: AcquiredDevice['id'] }) => ({ payload }),
);

const clearDevicePersistentData = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/clearDevicePersistentData`,
);

type SetEntropyCheckResultParams = { deviceId: AcquiredDevice['id'] } & EntropyCheckResult;
const setEntropyCheckResult = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/setEntropyCheckResult`,
...
const setDelegatedIdentityKey = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/setDelegatedIdentityKey`,
...
const setDeviceAuthenticityResult = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/setDeviceAuthenticityResult`,
...
const setManualDeviceCheckSuccess = createAction(
    `${PERSISTENT_DEVICE_DATA_MODULE_PREFIX}/setManualDeviceCheckSuccess`,
