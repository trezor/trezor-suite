 ...
 * Token network
 */
export type YieldsResponseItemsItemStateConcentratedLiquidityPoolStateBaseTokenNetwork =
    (typeof YieldsResponseItemsItemStateConcentratedLiquidityPoolStateBaseTokenNetwork)[keyof typeof YieldsResponseItemsItemStateConcentratedLiquidityPoolStateBaseTokenNetwork];

export const YieldsResponseItemsItemStateConcentratedLiquidityPoolStateBaseTokenNetwork = {
    ethereum: 'ethereum',
