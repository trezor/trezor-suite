 ...
 * Token network
 */
export type GetYield200OutputTokenNetwork =
    (typeof GetYield200OutputTokenNetwork)[keyof typeof GetYield200OutputTokenNetwork];

export const GetYield200OutputTokenNetwork = {
    ethereum: 'ethereum',
