 ...
 * Token network
 */
export type YieldDtoStateConcentratedLiquidityPoolStateBaseTokenNetwork =
    (typeof YieldDtoStateConcentratedLiquidityPoolStateBaseTokenNetwork)[keyof typeof YieldDtoStateConcentratedLiquidityPoolStateBaseTokenNetwork];

export const YieldDtoStateConcentratedLiquidityPoolStateBaseTokenNetwork = {
    ethereum: 'ethereum',
