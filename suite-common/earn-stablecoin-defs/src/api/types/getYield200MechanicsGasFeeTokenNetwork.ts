 ...
 * Token network
 */
export type GetYield200MechanicsGasFeeTokenNetwork =
    (typeof GetYield200MechanicsGasFeeTokenNetwork)[keyof typeof GetYield200MechanicsGasFeeTokenNetwork];

export const GetYield200MechanicsGasFeeTokenNetwork = {
    ethereum: 'ethereum',
