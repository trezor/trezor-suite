 ...
 * Token network
 */
export type GetYield200StatePricePerShareStateQuoteTokenNetwork =
    (typeof GetYield200StatePricePerShareStateQuoteTokenNetwork)[keyof typeof GetYield200StatePricePerShareStateQuoteTokenNetwork];

export const GetYield200StatePricePerShareStateQuoteTokenNetwork = {
    ethereum: 'ethereum',
