 ...
 * Token network
 */
export type GetYield200StateConcentratedLiquidityPoolStateBaseTokenNetwork =
    (typeof GetYield200StateConcentratedLiquidityPoolStateBaseTokenNetwork)[keyof typeof GetYield200StateConcentratedLiquidityPoolStateBaseTokenNetwork];

export const GetYield200StateConcentratedLiquidityPoolStateBaseTokenNetwork = {
    ethereum: 'ethereum',
