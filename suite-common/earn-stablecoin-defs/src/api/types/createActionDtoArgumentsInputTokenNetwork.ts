 ...
 */
export type CreateActionDtoArgumentsInputTokenNetwork =
    (typeof CreateActionDtoArgumentsInputTokenNetwork)[keyof typeof CreateActionDtoArgumentsInputTokenNetwork];

export const CreateActionDtoArgumentsInputTokenNetwork = {
    ethereum: 'ethereum',
