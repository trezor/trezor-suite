 ...
 */
export type YieldsResponseItemsItemNetwork =
    (typeof YieldsResponseItemsItemNetwork)[keyof typeof YieldsResponseItemsItemNetwork];

export const YieldsResponseItemsItemNetwork = {
    ethereum: 'ethereum',
