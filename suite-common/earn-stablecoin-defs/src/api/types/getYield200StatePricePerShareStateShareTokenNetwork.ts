 ...
 * Token network
 */
export type GetYield200StatePricePerShareStateShareTokenNetwork =
    (typeof GetYield200StatePricePerShareStateShareTokenNetwork)[keyof typeof GetYield200StatePricePerShareStateShareTokenNetwork];

export const GetYield200StatePricePerShareStateShareTokenNetwork = {
    ethereum: 'ethereum',
