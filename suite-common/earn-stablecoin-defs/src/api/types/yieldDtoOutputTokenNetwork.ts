 ...
 * Token network
 */
export type YieldDtoOutputTokenNetwork =
    (typeof YieldDtoOutputTokenNetwork)[keyof typeof YieldDtoOutputTokenNetwork];

export const YieldDtoOutputTokenNetwork = {
    ethereum: 'ethereum',
