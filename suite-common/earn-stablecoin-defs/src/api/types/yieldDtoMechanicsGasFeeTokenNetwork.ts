 ...
 * Token network
 */
export type YieldDtoMechanicsGasFeeTokenNetwork =
    (typeof YieldDtoMechanicsGasFeeTokenNetwork)[keyof typeof YieldDtoMechanicsGasFeeTokenNetwork];

export const YieldDtoMechanicsGasFeeTokenNetwork = {
    ethereum: 'ethereum',
