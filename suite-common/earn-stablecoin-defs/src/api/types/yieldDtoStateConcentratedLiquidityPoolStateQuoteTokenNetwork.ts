 ...
 * Token network
 */
export type YieldDtoStateConcentratedLiquidityPoolStateQuoteTokenNetwork =
    (typeof YieldDtoStateConcentratedLiquidityPoolStateQuoteTokenNetwork)[keyof typeof YieldDtoStateConcentratedLiquidityPoolStateQuoteTokenNetwork];

export const YieldDtoStateConcentratedLiquidityPoolStateQuoteTokenNetwork = {
    ethereum: 'ethereum',
