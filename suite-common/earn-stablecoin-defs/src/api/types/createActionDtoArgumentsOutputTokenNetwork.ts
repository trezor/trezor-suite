 ...
 */
export type CreateActionDtoArgumentsOutputTokenNetwork =
    (typeof CreateActionDtoArgumentsOutputTokenNetwork)[keyof typeof CreateActionDtoArgumentsOutputTokenNetwork];

export const CreateActionDtoArgumentsOutputTokenNetwork = {
    ethereum: 'ethereum',
