 ...
 * Token network
 */
export type YieldsResponseItemsItemOutputTokenNetwork =
    (typeof YieldsResponseItemsItemOutputTokenNetwork)[keyof typeof YieldsResponseItemsItemOutputTokenNetwork];

export const YieldsResponseItemsItemOutputTokenNetwork = {
    ethereum: 'ethereum',
