 ...
 * Token network
 */
export type YieldsResponseItemsItemTokenNetwork =
    (typeof YieldsResponseItemsItemTokenNetwork)[keyof typeof YieldsResponseItemsItemTokenNetwork];

export const YieldsResponseItemsItemTokenNetwork = {
    ethereum: 'ethereum',
