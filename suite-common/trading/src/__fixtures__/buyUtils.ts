...
const cexdirectMinMaxError: BuyTrade = {
    fiatStringAmount: '10',
    fiatCurrency: 'EUR',
...
export const mercuryoApplePayQuote: BuyTrade = {
    fiatStringAmount: '10',
    fiatCurrency: 'EUR',
    receiveCurrency: bitcoin,
...
const simplexMinMaxError: BuyTrade = {
    fiatStringAmount: '10',
    fiatCurrency: 'EUR',
    receiveCurrency: bitcoin,
...
export const MIN_MAX_QUOTES_OK: BuyTrade[] = [
    cexdirectMinMaxError,
    mercuryoApplePayQuote,
    simplexMinMaxError,
];

const mercuryoAlternativeQuote: BuyTrade = {
...
const cexdirectAlternativeQuote: BuyTrade = {
    fiatStringAmount: '47.12',
    fiatCurrency: 'EUR',
    receiveCurrency: bitcoin,
...
const simplexAlternativeQuote: BuyTrade = {
    fiatStringAmount: '47.12',
    fiatCurrency: 'EUR',
    receiveCurrency: bitcoin,
...
export const simplexAlternativeCzkQuote: BuyTrade = {
...
export const ALTERNATIVE_QUOTES: BuyTrade[] = [
    mercuryoAlternativeQuote,
    cexdirectAlternativeQuote,
    simplexAlternativeQuote,
