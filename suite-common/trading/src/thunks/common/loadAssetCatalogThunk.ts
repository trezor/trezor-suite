...
/**
 * @deprecated Temporary code to use trading catalogue as a data source for global receive flow
 * TODO delete this when a new appropriate data source is used there.
 */
