...
const MIN_MAX_QUOTES_OK: SellFiatTrade[] = [
    {
        fiatStringAmount: '10',
        fiatCurrency: 'EUR',
        rate: 20000,
...
const MIN_MAX_QUOTES_LOW: SellFiatTrade[] = [
    {
        fiatStringAmount: '10',
        fiatCurrency: 'EUR',
        cryptoCurrency: bitcoin,
...
const MIN_MAX_QUOTES_HIGH: SellFiatTrade[] = [
    {
...
const ALTERNATIVE_QUOTES: SellFiatTrade[] = [
    {
...
export const sellUtilsFixtures = {
    QUOTE_REQUEST_FIAT,
