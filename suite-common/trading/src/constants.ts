...
import { type NetworkType, toNetworkSymbolNonTestnet } from '@suite-common/wallet-config';
...
export const TRADING_DEFAULT_CRYPTO_CURRENCY = toNetworkSymbolNonTestnet('btc');
