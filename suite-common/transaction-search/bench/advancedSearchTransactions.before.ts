/**
 * A frozen copy of this module as it was before the search was optimized, kept only so that
 * `searchBenchmark.ts` can time the two against each other and check they agree. Not used by
 * anything else; do not fix bugs here.
 */
