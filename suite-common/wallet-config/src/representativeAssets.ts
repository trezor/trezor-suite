...
const representativeAssets: Readonly<Record<NetworkSymbol, readonly RepresentativeAsset[]>> = {
    [asNetworkSymbol('btc')]: [{ symbol: 'BTC' }],
    [asNetworkSymbol('eth')]: [
        { symbol: 'ETH' },
    ...
    [asNetworkSymbol('xrp')]: [{ symbol: 'XRP' }],
    [asNetworkSymbol('ltc')]: [{ symbol: 'LTC' }],
    [asNetworkSymbol('bch')]: [{ symbol: 'BCH' }],
    [asNetworkSymbol('doge')]: [{ symbol: 'DOGE' }],
    [asNetworkSymbol('zec')]: [{ symbol: 'ZEC' }],
} as const;
