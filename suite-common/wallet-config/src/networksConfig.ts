...
export const networks = {
    ...
    bnb: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://staging-bsc.trezor.io/tx/',
            account: 'https://staging-bsc.trezor.io/address/',
            nft: 'https://staging-bsc.trezor.io/nft/',
            address: 'https://staging-bsc.trezor.io/address/',
        },
        features: ['rbf', 'sign-verify', 'tokens'],
        label: 'TR_NETWORK_BNB_LABEL',
        customBackends: ['blockbook'],
        accountTypes: {},
    },
    etc: {
