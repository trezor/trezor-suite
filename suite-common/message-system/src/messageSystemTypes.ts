...
export const Feature = {
    ...
    // subset of `firmwareHashCheck`: can turn off timeout result, and also may bear `timeoutThresholdsPerModel` payload, see createSuiteConnectInit and createNativeConnectInit
