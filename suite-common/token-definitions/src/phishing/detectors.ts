...
/**
 * A claimable balance naming the account as a claimant, created by someone else. Nothing has moved:
 * the value arrives only if the account claims it, and paying the reserve to do so is the point of
 * the scam. Anyone can name any account, no trustline required, which makes this the one way to put
 * an arbitrary asset in front of a Stellar user unasked.
 */
