...
import { type AccountType, type BackendType, type Bip43Path, type NetworkSymbol } from '@suite-common/wallet-config';
import {
    type AddressAlias,
    type ContractInfo,
    type StakingPool,
...
import { type AccountInfo, type PROTO, type StaticSessionId, type TokenInfo } from '@trezor/connect';
