...
import { AccountBalanceHistory } from '../../balanceHistoryUtils';

export const btcAccountInfoResult: AccountInfo = {
    descriptor:
...
export const btcAccountBalanceHistoryResult: AccountBalanceHistory[] = [
    {
        time: 1665666497,
        txs: 1,
        received: '521229',
