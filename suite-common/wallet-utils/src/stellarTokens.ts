...
/** Memo for a trustline change: the operation already spells out the asset code and issuer. */
...
/** As `getStellarTrustlineMemoFromMetadata`, but bounded — the memo must not delay the prompt. */
