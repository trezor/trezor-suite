...
import {
    type MonthKey,
    analyzeTransactions,
    enhanceTransaction as enhanceTransactionBase,
    ...
    getRbfParams as getRbfParamsBase,
    getTargetAmount as getTargetAmountBase,
...
const enhanceTransaction = (
    transaction: Parameters<typeof enhanceTransactionBase>[1],
    account: Parameters<typeof enhanceTransactionBase>[2],
) => enhanceTransactionBase(mockNetworkConfigDeps, transaction, account);

const getRbfParams = (
    transaction: Parameters<typeof getRbfParamsBase>[1],
    account: Parameters<typeof getRbfParamsBase>[2],
) => getRbfParamsBase(mockNetworkConfigDeps, transaction, account);

const getTargetAmount = (
    target: Parameters<typeof getTargetAmountBase>[1],
    transaction: Parameters<typeof getTargetAmountBase>[2],
) => getTargetAmountBase(mockNetworkConfigDeps, target, transaction);
