...
import {
    constructTransactionReviewOutputs as constructTransactionReviewOutputsBase,
    isClearSignedEvmTradingSwapTransaction as isClearSignedEvmTradingSwapTransactionBase,
} from './reviewTransactionUtils';

const constructTransactionReviewOutputs = (
    params: Omit<
        Parameters<typeof constructTransactionReviewOutputsBase>[0],
        keyof typeof mockNetworkConfigDeps
    >,
) => constructTransactionReviewOutputsBase({ ...mockNetworkConfigDeps, ...params });

const isClearSignedEvmTradingSwapTransaction = (
    params: Omit<
        Parameters<typeof isClearSignedEvmTradingSwapTransactionBase>[0],
        keyof typeof mockNetworkConfigDeps
    >,
) => isClearSignedEvmTradingSwapTransactionBase({ ...mockNetworkConfigDeps, ...params });
