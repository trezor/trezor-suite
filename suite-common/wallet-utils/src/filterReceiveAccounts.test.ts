...
describe('filter receive accounts', () => {
    it('checks if account is debug only type', () => {
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'legacy', 'btc')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'segwit', 'btc')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'coinjoin', 'btc')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'taproot', 'btc')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'ledger', 'btc')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'legacy', 'eth')).toBe(true);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'ledger', 'eth')).toBe(true);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'ledger', 'trx')).toBe(true);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'normal', 'regtest')).toBe(false);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'legacy', 'tsep')).toBe(true);
        expect(isDebugOnlyAccountType(mockNetworkConfigDeps, 'legacy', 'thod')).toBe(true);
    });
