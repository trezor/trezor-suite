...
export interface UnstakeThunkArguments {
    account: Account;
    amount: string;
    resourceType: TronResourceType;
}

export type ComposeTronUnstakeFeeLevelsThunkState = NetworksRootState;

export const composeTronUnstakeFeeLevelsThunk = createThunk<
    PrecomposedLevels,
    UnstakeThunkArguments,
    { state: ComposeTronUnstakeFeeLevelsThunkState; rejectValue: TronStakeError }
>(
