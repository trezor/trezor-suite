...
([selectorsUtils.ts](../../suite-common/redux-utils/src/selectorsUtils.ts)), but don't author a new
parameterized one — that has been tried here and abandoned. What stays in the component earns a `useMemo`
...
const EMPTY_ADDRESSES: AccountAddress[] = [];
