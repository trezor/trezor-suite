...
// eslint-disable-next-line import/no-extraneous-dependencies -- Temporary bridge until Ripple compose dependencies are moved into the network module.
...
export const createComposeRippleTransactionFeeLevels =
